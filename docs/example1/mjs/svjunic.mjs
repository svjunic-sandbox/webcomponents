...
var hoge2 = "var hoge"; // eslint-disable-line
...
customElements.define(
  ...
  class extends HTMLElement {
    constructor() {
      ...
      //// {{{ slotchange
      //Array.prototype.forEach.call(this.shadowRoot.querySelectorAll('slot'), el => {
      //  el.addEventListener('slotchange', () => {
      //    console.log('fire "slotchange" event', el);
      //  });
      //});
      //// }}}

      //// {{{
      //// パブリングでshadowRootでイベントを受け取ることも可能
      //// windowのほうにはパブリングはいかない
      //this.shadowRoot.addEventListener('slotchange', function(e) {
      //  console.log('fire "slotchange" event', e.target);
      //});
      //// }}}
